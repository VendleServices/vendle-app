    ...
    const [reviews, setReviews] = useState<Review[]>([
        {
            ...
            rating: 5,
            comment:
                "Exceptional work on our water damage restoration project. The team was professional, thorough, and completed the job ahead of schedule. Their attention to detail and communication throughout the process was outstanding. Would highly recommend!",
            ...
            response:
                "Thank you for your kind words, Sarah! We're thrilled to hear that our team exceeded your expectations. It was a pleasure working with you on your restoration project.",
        ...
        },
        {
            ...
            rating: 4,
            comment:
                "Good work on the fire damage cleanup. The team was responsive and professional. The only reason for 4 stars instead of 5 is that the timeline was slightly longer than initially estimated. However, the quality of work was excellent.",
            ...
            response:
                "Thank you for your feedback, Michael. We appreciate your understanding regarding the timeline extension, which was necessary to ensure the highest quality of work. We're glad you were satisfied with the results.",
                        ...
                        <div className="flex justify-center mb-2">
                            {[...Array(5)].map((_, i) => (
                                <Star
                                    key={i}
                                    className={`w-5 h-5 ${
                                        i < Math.round(Number(getAverageRating())) ? "text-yellow-400 fill-yellow-400" : "text-gray-300"
                                    }`}
                                />
                            ))}
                        </div>
                                ...
                                {review.response ? (
                                    <div className="mt-4 pt-4 border-t bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p className="text-xs text-gray-500 mt-2">
                                            Response from {user?.email} on {review.response_date}
                                        </p>
                                    </div>
                                ) : (
                                    <div className="mt-4 pt-4 border-t">
                                        <Button variant="outline" onClick={() => handleRespondClick(review)}>
                                            Respond to Review
                                        </Button>
                                    </div>
                                )}
