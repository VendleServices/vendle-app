...
import { MapPin, DollarSign, Hammer, Wrench, ArrowRight } from "lucide-react";
    ...
    <div className="bg-white border border-gray-200 rounded hover:border-gray-300 transition-colors">
        ...
        <div className="flex items-start justify-between gap-3 mb-2">
          ...
          <span className={`flex-shrink-0 flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-medium ${
            project.status === 'Active'
              ? 'bg-vendle-teal/10 text-vendle-teal border border-vendle-teal/20'
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="p-3 bg-vendle-teal/5 rounded border border-vendle-teal/10">
          ...
          <p className="text-lg font-semibold text-gray-900">${project.contractValue?.toLocaleString() || '0'}</p>
        </div>
