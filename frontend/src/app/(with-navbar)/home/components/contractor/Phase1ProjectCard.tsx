...
import { MapPin, File, DollarSign, Calendar, ArrowRight, Gavel } from "lucide-react";
    ...
    <div className="bg-white border border-gray-200 rounded hover:border-gray-300 transition-colors">
      ...
      <div className="p-4 border-b border-gray-100">
        <div className="flex items-start justify-between gap-3 mb-2">
          ...
          <span className="flex-shrink-0 flex items-center gap-1 px-2 py-0.5 rounded bg-vendle-blue/10 text-[10px] font-medium text-vendle-blue">
      ...
      <div className="p-4 space-y-3">
        ...
        {project.adjustmentPdf && (
          ...
          >
            <File className="h-3.5 w-3.5 text-vendle-blue" />
            <span className="text-gray-700">Adjustment PDF</span>
            <span className="ml-auto text-vendle-blue text-[10px] font-medium">View</span>
          </a>
        )}
