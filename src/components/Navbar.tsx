  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between">
        ...
        >
          {isMobileMenuOpen ? (
            <X className="w-6 h-6 text-vendle-navy" />
          ) : (
            <Menu className="w-6 h-6 text-vendle-navy" />
          )}
        </button>
        ...
        {isMobileMenuOpen && (
          <div className="fixed inset-0 bg-white z-40 pt-20 px-4">
            <nav className="flex flex-col space-y-4">
              <Link 
                to="/" 
                className="px-4 py-2 text-vendle-navy/90 hover:text-vendle-blue transition-colors font-medium"
                onClick={toggleMobileMenu}
              >
                Home
              </Link>
              ...
              {!isAuthenticated ? (
                <div className="flex flex-col space-y-2 pt-4">
                  ...
                  <Link to="/auth?mode=signup" onClick={toggleMobileMenu}>
